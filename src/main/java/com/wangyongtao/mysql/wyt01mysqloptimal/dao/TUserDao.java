...
import com.wangyongtao.mysql.wyt01mysqloptimal.config.datasoureswitch.DataSource;
import com.wangyongtao.mysql.wyt01mysqloptimal.entity.TUser;
import org.apache.ibatis.annotations.Param;
import java.util.List;

/**
 * 多数据源切换表一(TUser)表数据库访问层
 *
 * @author makejava
 * @since 2020-04-10 15:44:16
 */
...
public interface TUserDao {
    ...
    @DataSource(name = "xiaobin-slave")
    TUser queryByIds(Integer id);
